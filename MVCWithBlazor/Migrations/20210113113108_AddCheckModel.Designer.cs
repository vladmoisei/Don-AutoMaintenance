...
namespace MVCWithBlazor.Migrations
{
    ...
    [Migration("20210113113108_AddCheckModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MVCWithBlazor.Models.ActionCheckModel", b =>
                {
                    b.Property<int>("ActionCheckModelID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int?>("ActiuneModelID")
                        .HasColumnType("int");

                    b.Property<DateTime>("DataBifatByOp")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("DataBifatBySef")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("DataLucru")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<bool>("IsCheckedByOp")
                        .HasColumnType("bit");

                    b.Property<bool>("IsCheckedBySef")
                        .HasColumnType("bit");

                    b.Property<string>("SefDeSchimb")
                    ...
                    b.HasKey("ActionCheckModelID");

                    b.HasIndex("ActiuneModelID");

                    b.ToTable("CheckModels");
                });

            modelBuilder.Entity("MVCWithBlazor.Models.ActiuneModel", b =>
                {
                    b.Property<int>("ActiuneModelID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<bool>("IsUseInputText")
                        .HasColumnType("bit");
                    ...
                    b.HasKey("ActiuneModelID");

                    b.HasIndex("UtilajModelID");

                    b.ToTable("ActiuneModels");
                });
            ...
            modelBuilder.Entity("MVCWithBlazor.Models.ActionCheckModel", b =>
                {
                    b.HasOne("MVCWithBlazor.Models.ActiuneModel", "ActiuneModel")
                        .WithMany()
                        .HasForeignKey("ActiuneModelID");
                });
